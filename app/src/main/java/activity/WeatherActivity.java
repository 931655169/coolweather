...
public class WeatherActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        weatherDespText=(TextView)findViewById(R.id.weather_deep);
        ...
        if (!TextUtils.isEmpty(countyCode)){
            ...
            weatherInfoLayout.setVisibility(View.VISIBLE);//设置控件是否可见
    ...
    /**
     * 从SharedPreference文件中读取存储的天气信息，并显示在界面上
     **/
    private void showWeather(){
        ...
        weatherDespText.setText(prefs.getString("weather_deep",""));
